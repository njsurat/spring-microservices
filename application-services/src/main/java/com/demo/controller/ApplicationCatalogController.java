...
import com.demo.domain.Application;
import com.demo.repositories.ApplicationRepository;
...
public class ApplicationCatalogController {
    ...
    private void getPersonInfo(Application app) {
        try {
            ...
            String userManagementService = "http://localhost:8083/persons/" + app.getOwnerId();
