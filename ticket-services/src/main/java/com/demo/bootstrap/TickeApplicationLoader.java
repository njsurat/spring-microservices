...
import com.demo.domain.Ticket;
import com.demo.repositories.TicketRepository;



@Component
public class TickeApplicationLoader implements ApplicationListener<ContextRefreshedEvent> {


    private TicketRepository ticketRepository;
    private Logger log = Logger.getLogger(TickeApplicationLoader.class);
